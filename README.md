...
# Trent Pierce  
**Senior AI / LLM Engineer • Security-Focused Architect • Full-Stack Builder**

Designing production AI systems that are structured, testable, and secure.

[GitHub](https://github.com/TrentPierce) • [Twitter](https://twitter.com/severesig) • [Email](mailto:pierce.trent@gmail.com)
...
> From physical security to digital systems to applied AI — the goal remains the same: build things that hold up under pressure.